...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/saravjay/HR_Attrition/master/Attr/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: 0.8715975477821853
exported_pipeline = GradientBoostingClassifier(learning_rate=0.1, max_depth=4, max_features=0.9500000000000001, min_samples_leaf=11, min_samples_split=7, n_estimators=100, subsample=0.15000000000000002)
